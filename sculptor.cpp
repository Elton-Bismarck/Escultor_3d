        ...
        for(int i = 0; i < nx; i++){
            for(int j = 0; j < ny; j++){
                for(int k = 0; k < nz; k++){
                    if(v[i][j][k].isOn == true){
                        valor = 8*contador;
                        xfiles << 4 << " " << 0 + valor << " " << 3 + valor << " " << 2 + valor << " " << 1 + valor << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
                        xfiles << 4 << " " << 4 + valor << " " << 5 + valor << " " << 6 + valor << " " << 7 + valor << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
                        xfiles << 4 << " " << 0 + valor << " " << 1 + valor << " " << 5 + valor << " " << 4 + valor << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
                        xfiles << 4 << " " << 0 + valor << " " << 4 + valor << " " << 7 + valor << " " << 3 + valor << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
                        xfiles << 4 << " " << 3 + valor << " " << 7 + valor << " " << 6 + valor << " " << 2 + valor << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
                        xfiles << 4 << " " << 1 + valor << " " << 2 + valor << " " << 6 + valor << " " << 5 + valor << " " << v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
                        contador++;
                    }
                }
            }
